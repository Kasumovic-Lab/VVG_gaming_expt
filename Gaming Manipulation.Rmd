...
Delete Rows where participants were unable to load or play game, had issues with the survey loading, or failed an attention check (27 people). Also delete rows where participants recorded gender as "Other" (4 people).
...
```{r}
plotSOI3 <- ggplot(data, aes(x = Age, y = SOIRTOTAL, color = Gender, shape = Gender, linetype = Gender)) + 
  geom_point(size=4) +
  ylim(5,75) +
  scale_colour_hue(l=50, guide = FALSE) +
  scale_x_continuous(limits=c(15,80)) +
